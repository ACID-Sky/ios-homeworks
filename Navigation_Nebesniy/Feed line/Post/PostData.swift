...
public var posts: [Post] = [
    Post(author: "Mark",
         ...
         image: UIImage(named:"animal") ?? UIImage(systemName: "display.2")!,
         likes: 10,
         views: 1000,
         id: "00EE9069-5931-4F8E-91D0-5DECE79C3B9A"),
    Post(author: "Wikipedia",
         ...
         image: UIImage(named:"Aust") ?? UIImage(systemName: "display.2")!,
         likes: 12,
         views: 2000,
    ...
    Post(author: "ACID",
         ...
         image: UIImage(named:"Delph") ?? UIImage(systemName: "display.2")!,
         likes: 15,
         views: 1500,
         id: "B0827EA0-EC8D-4BC4-BBBF-E3BB4B582AAF"),
    Post(author: "Wikipedia",
         ...
         image: UIImage(named:"Sun") ?? UIImage(systemName: "display.2")!,
         likes: 3,
         views: 1100,
         id: "4182B8B7-5309-4A64-A80D-8119086EDB14"),
    ]
